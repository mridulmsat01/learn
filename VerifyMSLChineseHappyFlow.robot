...
Library  Collections
Library     DataDriver  robot/SFSC_TestAutomation/testdata/Test.xlsx  sheet_name=MSL Chinese Happy Flow
Resource    Source.robot

Test Template  Verify MSL Chinese Happy flow

*** Test Cases ***
Verify MSL Chinese Happy flow  ${TestID}  ${TestName}  ${User_Input1}  ${Bot_Output1}  ${User_Input2}  ${Bot_Output2}
